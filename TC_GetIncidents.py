...
driver = webdriver.Chrome("E:\\SeleniumQuickStart\\drivers\\chromedriver.exe", chrome_options=options)
...
sheet = wb.sheet_by_name("GetIncidents")
...
for x in range(0, elementiterator, 2):
    ...
    # print("Test Case Get Incident for row " + str(index))
    if GetIncResp.find("incidents") != -1:

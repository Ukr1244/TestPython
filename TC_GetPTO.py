...
for x in range(0, elementiterator, 2):
    ...
    GetPTOResp = driver.find_element_by_xpath("/html/body/div[1]/div[2]/div/div[3]/div[2]/div[2]/div["+str(z)+"]/div") \
            .get_attribute('textContent')
    index = index + 1
    # print("Response :" + GetPTOResp)
    # print("Test Case Get PTO for row " + str(index))
    if GetPTOResp.find("approvals") != -1:
